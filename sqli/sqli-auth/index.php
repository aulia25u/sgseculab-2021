...
<body>
    <center>
                ...
                if (isset($_POST['submit'])) {
					...
					if ($rows > 0) {
                        if ($_SESSION['username'] = $username) {
                           echo "<div class='login100-form'><br><br>
                                <center><div class='alert alert-success' role='alert'>Login Success</div></center><br/>
				                <br><br>
        ...
        <?php
    echo '<center><br><br><div class="alert alert-success" role="alert">Username : seculab & Password : seculab123';
   
    echo '</div></div></center><br>';
                 }
			if(isset($query)) { 
				echo '<center><br><br><div class="alert alert-success" role="alert">SQL Query : ';
				echo $query; 
				echo '</div></div></center><br>';} 
		?>
                </div>
